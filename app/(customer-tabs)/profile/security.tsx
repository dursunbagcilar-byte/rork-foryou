    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <Text style={styles.sectionTitle}>Yolculuk Güvenliği</Text>
          <View style={styles.card}>
            <View style={styles.menuItem}>
              ...
              <View style={styles.menuLabelWrap}>
                ...
                <Text style={styles.menuDesc}>Yolculuk sırasında konumunuzu paylaşın</Text>
              </View>
              <Switch
...
const styles = StyleSheet.create({
  ...
  shieldTitle: { fontSize: 18, fontWeight: '700', color: Colors.light.text, marginBottom: 4 },
  ...
  saveBtnText: { fontSize: 15, fontWeight: '600', color: Colors.light.background },
  contactRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 16,
  ...
  contactInitial: { fontSize: 16, fontWeight: '700', color: '#fff' },
  contactInfo: { flex: 1 },
  contactName: { fontSize: 15, fontWeight: '500', color: Colors.light.text },
  ...
  addContactText: { fontSize: 15, fontWeight: '600', color: Colors.light.primary },
